...
@section('content')
    ...
    <center> <div class="card_buttons"><a href="{{route('tovar')}}"><input type="submit" class="add_to_cart" name="update" style="font-size: 21px;" value="Добавить товар и посмотреть заказы"></div></a></center>
                            ...
                            <div class="catalog_card">
                                ...
                                <div class="card_details">
                                    ...
                                    <div class="card_buttons">
                                        <form action="{{route('catalog_izm')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="id_tovara" value="{{$tt->id}}">
                                            
                                            <div class="card_buttons">
                                                <input type="submit" class="add_to_cart" name="update" value="Изменить">
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="card_buttons">
                                        <form action="" method="post">
                                            ...
                                            <div class="card_buttons">
                                                <input type="submit" name="delete" class="add_to_cart" value="Удалить ">
                                            </div>
                                        </form>
                                    </div>
                                </div>
